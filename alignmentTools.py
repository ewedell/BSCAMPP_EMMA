...
def printHelper():
    ...
    print("2.\tdef read_fasta --\tRead in a fasta file, used in Alignment()")
    print("3.\tdef write_fasta --\tWrite an Alignment object to local.")
    print("4.\tclass Alignment() --\tAlignment class, for jobs with alignment")
